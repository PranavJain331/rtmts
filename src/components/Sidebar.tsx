...
import { Shield, Activity, Network, Settings } from 'lucide-react';

export const Sidebar: React.FC = () => {
  const navItems = [
    { name: 'Dashboard', path: '/', icon: Shield },
    { name: 'Threat Logs', path: '/logs', icon: Activity },
    { name: 'Blockchain Monitor', path: '/blockchain', icon: Network },
  ];
  ...
  return (
    <aside className="w-64 bg-[#0a0e17] border-r border-slate-800 flex flex-col h-full shrink-0">
      <div className="p-6 flex items-center space-x-3 text-cyan-400">
        ...
        <h1 className="font-bold text-lg leading-tight tracking-wider">RTMTS<br/><span className="text-xs font-normal text-slate-400 uppercase">Scanner</span></h1>
      </div>
